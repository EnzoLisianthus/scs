pcall(function()
	local espcolor = Color3.fromRGB(230, 5, 172)
	local wallhack_esp_transparency = .9
	local gui_hide_button = {Enum.KeyCode.LeftControl, "h"}
	local plrs = game:GetService("Players")
	local lplr = game:GetService("Players").LocalPlayer
	local TeamBased = true ; local teambasedswitch = "o"
	local presskeytoaim = true; local aimkey = "e"
	aimbothider = true; aimbothiderspeed = .5
	local Aim_Assist = false ; Aim_Assist_Key = {Enum.KeyCode.LeftControl, "z"}
	local espupdatetime = 0.5; autoesp = true
	local abs = math.abs
	...
	Move.Draggable = true
	Move.Parent = Gui
	Move.BackgroundColor3 = Color3.new(0.0431373, 0.1, 0.0745098)
	...
	EspStatus.TextColor3 = Color3.new(0.0431373, 0.1, 0.0745098)
	...
	st1.TextColor3 = Color3.new(0.0431373, 0.1, 0.0745098)
	st1.TextScaled = true
	st1.TextSize = 14
	...
	st1_2.TextColor3 = Color3.new(0.0431373, 0.1, 0.0745098)
	...
	st1_3.TextColor3 = Color3.new(0.0431373, 0.1, 0.0745098)
	...
	aimbothiderbox.FocusLost:Connect(function()
		...
		if aimbothider == true then
			aimbothiderbox.TextColor3 =Color3.fromRGB(11, 55, 19)
		else
			aimbothiderbox.TextColor3 =Color3.fromRGB(255, 0, 0)
		end
		if numb ~= nil then
