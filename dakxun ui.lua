local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EnzoLisianthus/sss/refs/heads/main/ui%20asset.txt"))()

local win = Library:CreateWindow("🧪 dakxun UI ")

local tab1 = win:CreateTab("👀 Visuals")
tab1:AddButton("하윤사랑ESP", function()
    -- 하윤사랑ESP
...
tab1:AddButton("서버 ID 출력", function()
    print("서버 JobId:", game.JobId)
end)

local tab2 = win:CreateTab("🐞 Misc")
tab2:AddButton("Rejoin", function()
...
tab2:AddButton("카메라 뷰포트 크기", function()
    print("Viewport:", workspace.CurrentCamera.ViewportSize)
end)

local tab3 = win:CreateTab("🧪 랜덤/시간")
tab3:AddButton("랜덤 숫자", function()
    print("랜덤:", math.random(1, 100))
end)
tab3:AddButton("시간 출력", function()
    print("Time:", os.date())
end)

local tab4 = win:CreateTab("📦 scs")
tab4:AddButton("admin 6.3.2", function()
...
tab4:AddButton("hitbox extender", function()
--[[
...
tab4:AddButton("게임 링크 복사", function()
    setclipboard("https://roblox.com/games/" .. game.PlaceId)
    print("게임 링크 복사됨!")
end)
